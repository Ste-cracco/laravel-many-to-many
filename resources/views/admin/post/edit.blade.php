...
<div class="container">
  <div class="row">
    <div class="col-12">
      <form action="{{ route('admin.post.update', $post) }}" method="POST"> {{-- Oltre la views gli passo il $post --}}
        ...
        <div class="form-group">
          ...
          <small id="helpCategory" class="form-text text-muted">Seleziona la Categoria del Post</small>
          @error('category_id')
        ...
        <div class="form-group">
          ...
          @foreach ($tags as $tag)
            <div class="form-check form-check-inline">
              <input class="form-check-input" name="tags[]" @if (in_array($tag->id, old('tags',$post->tags->pluck('id')->all()) ) ) checked  @endif type="checkbox" id="tag-{{$tag->id}}" value="{{ $tag->id }}"> <!-- *Attenzione all' attributo name -->
